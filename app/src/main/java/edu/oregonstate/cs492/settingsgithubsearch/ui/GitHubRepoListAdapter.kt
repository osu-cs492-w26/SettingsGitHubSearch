...
class GitHubRepoListAdapter() : RecyclerView.Adapter<GitHubRepoListAdapter.GitHubRepoViewHolder>() {
    ...
    class GitHubRepoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val starsTV: TextView = itemView.findViewById(R.id.tv_stars)
        private val descriptionTV: TextView = itemView.findViewById(R.id.tv_description)
        ...
        fun bind(gitHubRepo: GitHubRepo) {
            ...
            starsTV.text = gitHubRepo.stars.toString()
            descriptionTV.text = gitHubRepo.description
        }
    }
}